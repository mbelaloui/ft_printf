...
/*   Updated: 2018/02/10 14:26:50 by mbelalou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_test_decimal(int decimal)
{
	...
	char *decimal_with_plus_minlen					= "%#+*d";
	char *decimal_with_plus_precision				= "%#+.*d";
	char *decimal_with_plus_minlen_precision		= "%#+*.*d";
	char *decimal_with_plus_dash_minlen_precision	= "%#+-*.*d";



	char *decimal_simple_space							= "%# d";
	char *decimal_with_dash_space						= "%# -d";
	char *decimal_with_minlen_space						= "%# *d";
	char *decimal_with_precision_space					= "%# .*d";
	char *decimal_with_minlen_precision_space			= "%# *.*d";
	char *decimal_with_dash_minlen_precision_space		= "%#- *.*d";
	char *decimal_with_plus_space						= "%#+ d";
	char *decimal_with_plus_dash_space					= "%#+ -d";
	char *decimal_with_plus_minlen_space				= "%#+ *d";
	char *decimal_with_plus_precision_space				= "%#+ .*d";
	char *decimal_with_plus_minlen_precision_space		= "%#+ *.*d";
	char *decimal_with_plus_dash_minlen_precision_space	= "%#+- *.*d";

	char *decimal_simple_space_zero								= "%#0 d";
	char *decimal_with_dash_space_zero							= "%#0 -d";
	char *decimal_with_minlen_space_zero						= "%#0 *d";
	char *decimal_with_precision_space_zero						= "%#0 .*d";
	char *decimal_with_minlen_precision_space_zero				= "%#0 *.*d";
	char *decimal_with_dash_minlen_precision_space_zero			= "%#-0 *.*d";
	char *decimal_with_plus_space_zero							= "%#+0 d";
	char *decimal_with_plus_dash_space_zero						= "%#+0 -d";
	char *decimal_with_plus_minlen_space_zero					= "%#+0 *d";
	char *decimal_with_plus_precision_space_zero				= "%#+0 .*d";
	char *decimal_with_plus_minlen_precision_space_zero			= "%#+0 *.*d";
	char *decimal_with_plus_dash_minlen_precision_space_zero	= "%#+-0 *.*d";
/*
