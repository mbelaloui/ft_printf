...
/*   Updated: 2018/02/10 15:18:30 by mbelalou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../test.h"

int		ft_test_Char_with_precision(const char *c,const char*format, int min_length, int *num_test)
{
	int ret1, ret2;

	ft_print_precision_title(c,format,  min_length, num_test);
