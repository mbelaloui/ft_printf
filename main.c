...
/*   Updated: 2018/02/01 13:36:22 by mbelalou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	printf("-1-\t%s\n", ft_itoa(number));
	...
	ft_putstr("---------------- *char with min_len == 10 ------------------\n");
   ...
   printf("-3->%10s<\n",  ft_itoa(number));
	...
	ft_putstr("--------- *char with min_len == 10 and >\"-\"< ------------\n");
...
/*
	number++;
//	printf("-2-\t%s ,%s\n",  ft_itoa(number), arg_1);
//	fflush(stdout);
*/
//	ft_printf("-2-\t%0-+# 123.489Lsn\n",  ft_itoa(number), arg_1);
//	ft_putstr("\n");
/*
	number++;
//	printf("-3-\t%s%s\n",  ft_itoa(number), arg_1);
...
*/
	...
	fflush(stdout);
	ft_putstr("----------------------- period test ------------------------\n");

	ft_putstr("--------------------- pressision test ----------------------\n");

	ft_putstr("----------------------- format test ------------------------\n");

	 printf("Here is a number %d and a %s word.\n", number, pointer);

	ft_putstr(" -4- to print : <");
	printf("");
	fflush(stdout);
	ft_putstr("> \t\t\t\t\t print :");
	ft_putstr(" - < ");
	ft_printf("", arg_1);//, arg_2);//, arg_3, arg_4, arg_5, arg_6);
	ft_putstr(">\n");

	ft_putstr(" -5- to print : <");
	printf("bonjour ");
	fflush(stdout);
	ft_putstr("> \t\t\t\t  *5* print : - <");
	...
	ft_putstr(" -6- to print : <");
	printf("ya rien derier s");
	fflush(stdout);
	ft_putstr("> \t\t\t print : - <");
	ret = ft_printf("ya rien derier %+644-espaced ");
	ft_putstr(">\t return : ");
	ft_putnbr(ret);
	ft_putstr("\n");

	ft_putstr(" -7- to print : <");
	printf("bonjour %%%s voila ", arg_1);
	fflush(stdout);
	ft_putstr("> \t\t\t\t print : - <");
	ret  = ft_printf("bonjour %s voila ", arg_1);
	ft_putstr(">\t return : ");
	ft_putnbr(ret);
	ft_putstr("\n");
	...
	ft_putstr(" -7- to print : <");
	printf("printf n'est pas suposer gerer ca ... !");
	fflush(stdout);
	ft_putstr("> \t\t\t\t print : - <");
	ret  = ft_printf("bonjour %d voila ", arg_1);
	ft_putstr(">\t return : ");
	ft_putnbr(ret);
	ft_putstr("\n");


	ft_putstr(" -8- to print : <");
	printf("printf n'est pas suposer gerer ca ... !");
	fflush(stdout);
	ft_putstr("> \t\t\t\t print : - <");
	ret  = ft_printf("bonjour voila %%%s%s hellow %%" hellow %%d %s[123456 %dd", arg_1, arg_2,arg_3);//, arg_4, arg_5, arg_6);
	ft_putstr(">\t return : ");
	ft_putnbr(ret);
	ft_putstr("\n");
