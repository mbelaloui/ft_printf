...
/*   Updated: 2018/03/02 12:28:09 by mbelalou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../test.h"

static int		run_test_minlenght_precision(int decimal, char **format, int *num_test,
...
static int		run_test(int decimal, char **format, int *num_test, int accuracy, char **titles)
{
	int succeed;
	int min_length;
	int max_lenght;
